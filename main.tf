//variable "example"{
//  description = "This is an example how to declare a variable in Terraform"
//  default = "foo"
//}
...
data "aws_iam_policy_document" "bucket_policy" {
  statement {
    ...
    resources = [ "arn:aws:s3:::questinnovations.org.org/*" ]
  }
}
...
resource "aws_s3_bucket" "website" {
  // argument = "${var.example}"
  bucket = "questinnovations.org"  // The name of the bucket.
